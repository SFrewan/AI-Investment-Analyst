...
/// </para>
/// </remarks>
public static class CoverageEvaluation
{
        ...
        bool wasRequested = true)
    {
        ...
        if (!acquirable)
        {
            ...
            return new CoverageVerdict(false, [], held.Count, 0, "not acquirable; no series expected");
        }
        ...
        return new CoverageVerdict(faults.Count > 0, faults, held.Count, expected, reason);
    }
